...
urlpatterns = [
    ...
    path("trainer/assignment/<int:assignment_id>/submissions/",
         views.trainer_assignment_submissions,
         name="trainer_assignment_submissions"),
    path("trainer/submission/<int:submission_id>/review/",
         views.trainer_submission_review,
         name="trainer_submission_review"),
    ...
    path("trainer/assignment/<int:assignment_id>/report/",
         views.trainer_assignment_report,
         name="trainer_assignment_report"),

    path("admin/reports/",
         views.admin_overall_report,
         name="admin_overall_report"),

    path(
        "student/certificate/<int:submission_id>/",
        views.download_certificate,
        name="download_certificate"
    ),
    path(
        "student/history/",
        views.student_exam_history,
