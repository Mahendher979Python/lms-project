...
from lmsbuild.study.models import StudyItem
from .models import Course
from .models import Course, StudyItem
...
def student_course_detail(request, course_id):
    ...
    # 2. Get all chapters/topics for this course
    # Assuming StudyItem has a 'course' field and 'item_type'
    topics = StudyItem.objects.filter(course=course, is_active=True).order_by('created_at')

    return render(request, 'accounts/student/course_detail.html', {
        'course': course,
        'topics': topics
    })
