...
def admin_course_list(request):
    ...
    return render(request, "accounts/admin/courses/course_list.html", {"courses": courses})
...
def admin_course_add(request):
    ...
    return render(request, "courses/admin_courses/course_add.html", {"teachers": teachers})
