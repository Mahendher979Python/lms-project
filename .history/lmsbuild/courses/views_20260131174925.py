...
def trainer_courses(request):
    ...
    return render(request,"trainer/courses.html",{
        "courses":courses
    })


# TRAINER STUDENTS (per course)
@login_required
def trainer_students(request,course_id):
    ...
    return render(request,"trainer/students.html",{
        "course":course,
        "students":students
    })
...
# ================= STUDENT VIEWS ==============================================================
@login_required
def student_materials(request,batch_id):
    ...
    materials = CourseMaterial.objects.filter(course=enroll.batch.course)

    return render(request,"student/materials.html",{
        "materials":materials,
        "course":enroll.batch.course
    })
