...
from accounts.models import TeacherProfile, Batch
...
def admin_media_list(request):
    ...
    return render(request, "courses/media/list.html", {"materials": materials})
...
def admin_material_all_list(request):
    ...
    materials = CourseMaterial.objects.filter(material_type__in=["pdf","image"])

    return render(request, "courses/material/admin/all_list.html", {"materials": materials})
...
def admin_material_upload(request, course_id):
    ...
    if request.method == "POST":
        ...
        return redirect("admin_material_all")
...
def trainer_course_list(request):
    ...
    return render(request, "courses/trainer_courses/course_list.html", {"courses": courses})
...
def trainer_course_preview(request, course_id):
    ...
    return render(request, "courses/trainer_courses/course_preview.html", {"course": course})
...
def trainer_material_upload(request, course_id):
    ...
    return render(request, "courses/material/trainer/upload.html", {"course": course})
...
def trainer_students(request, course_id):
    ...
    students = Enrollment.objects.filter(batch__in=batches)
