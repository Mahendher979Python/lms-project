...
from .forms import CourseForm, LessonForm, Lesson, LessonProgress
...
@login_required
def student_lesson_video(request, lesson_id):
    if request.user.role != "student":
        return redirect("login")
    ...
    return render(request, "courses/student/lesson_video.html", {
        "lesson": lesson
    })
