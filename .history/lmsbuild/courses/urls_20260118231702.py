...
urlpatterns = [
    ...
    path(
        "trainer/courses/<int:course_id>/lessons/edit/<int:lesson_id>/",
        views.trainer_lesson_edit,
        name="trainer_lesson_edit"
    ),
    path(
        "trainer/courses/<int:course_id>/lessons/delete/<int:lesson_id>/",
        views.trainer_lesson_delete,
        name="trainer_lesson_delete"
    ),
    ...
    path("student/course/list/", views.student_course_list, name='student_course_list'),
    ...
    # STUDENT VIEWS
    #=======================================
    path("student/videos/", views.student_video_list, name="student_video_list"),
    from django.urls import path
from . import views
...
urlpatterns = [
    ...
    path("student/lesson/<int:lesson_id>/",views.student_lesson_list,name="student_lesson_list"),

    path("student/lesson/video/<int:lesson_id>/",views.student_lesson_video,name="student_lesson_video"),
...
# STUDENT
# =========================
    path("student/courses/<int:course_id>/lessons/",views.student_lesson_list,name="student_lesson_list"),
