...
urlpatterns = [
    ...
    path("admin/courses/create/", views.admin_course_add, name="admin_course_create"),
    ...
    path("student/course/<int:course_id>/topics/",views.student_course_topics,name="student_course_topics"),
    path("student/course/<int:course_id>/download/",views.download_course,name="download_course"),
