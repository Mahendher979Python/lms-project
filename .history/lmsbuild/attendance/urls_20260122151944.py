...
from . import views
from .admin_views import admin_attendance_list, admin_monthly_report
...
urlpatterns = [
    ...
    path("admin/approve/<int:pk>/", views.admin_attendance_approve, name="admin_attendance_approve"),
    path("admin/reject/<int:pk>/", views.admin_attendance_reject, name="admin_attendance_reject"),
]
