...
urlpatterns = [
    ...
    # ===== ADMIN REPORTS =====
    path("admin/report/", admin_views.admin_monthly_report, name="admin_monthly_report"),
    path("admin/export/", admin_views.admin_attendance_export, name="admin_attendance_export"),
]
