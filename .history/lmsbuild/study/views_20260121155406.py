...
def trainer_notes_list(request):
    ...
    return render(request, "study/trainer/notes_list.html", {"notes": notes})
...
def trainer_notes_add(request):
    ...
    return render(request, "study/trainer/notes_add.html", {"students": students})
...
def student_notes_list(request):
    ...
    return render(request, "study/student/notes_list.html", {"notes": notes})
