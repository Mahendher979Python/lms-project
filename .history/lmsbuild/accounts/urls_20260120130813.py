...
path('dashboard/trainers/delete/<int:id>/', views.trainer_delete, name='trainer_delete'),
    ...
    path("admin/students/edit/<int:id>/", views.admin_edit_student, name="admin_edit_student"),
    path("admin/students/delete/<int:id>/", views.admin_delete_student, name="admin_delete_student"),

    path("admin/users/", views.admin_user_view, name="admin_user_view"),
]
