...
def student_list(request):
    ...
    return render(request, 'accounts/admin/student_list.html', {
        'students': students
    })
...
def student_add(request):
    ...
    return render(request, 'accounts/admin/student_add.html', {
        'courses': courses
    })


# ============================
# EDIT STUDENT (ONLY COURSES)
# ============================
def student_edit(request, pk):
    ...
    return render(request, 'accounts/admin/student_edit.html', {
        'student': student,
        'courses': courses
    })
...
def student_delete(request, pk):
    ...
    # user delete chesthe profile auto delete
    student.user.delete()
